...
return [
    ...
    */
    ...
    /*
     * Dejavu Sans font is missing glyphs for converted entities. Disable
     * entity conversion to avoid garbled characters for currency and
     * non-ASCII glyphs (e.g. ₱, €, £). If you still see missing glyphs,
     * install a Unicode-capable font (e.g. DejaVu Sans) into the
     * `storage/fonts` directory and register it with DomPDF.
     */
    ...
    'options' => [
         ...
         * @var string
         */
        // Use the bundled DejaVu Sans fonts which include wide Unicode glyph
        // coverage (currency symbols, accents, etc.). The Dompdf lib already
        // ships with DejaVu under `vendor/dompdf/dompdf/lib/fonts`.
