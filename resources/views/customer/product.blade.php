...
<style>
    ...
    .product-img { width: 380px; max-width: 45%; border-radius: 25px; border:2px solid #4A2C2A; box-shadow: 0 6px 12px rgba(74,44,42,0.15); }
...
<div class="product-page">
    <div class="product-header">
        <img class="product-img" src="{{ $product->image_url ? asset($product->image_url) : asset('images/espressodrink.jpg') }}" alt="{{ $product->name }}">
